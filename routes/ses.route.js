...
router.post('/onboard-subdomain', verifyToken(), authorize('manage_emails'), onboardSubdomain);
router.get('/subdomain-status', verifyToken(), authorize('manage_emails'),  checkSubdomainStatus);
